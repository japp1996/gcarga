            ...
            <ul>
              <li>
                <div class="col s6 file-field input-field">
                  <input-file-document :file="foto"  v-on:file="onCarnetChange"
              ...
              <li>
                <div class="col s6 file-field input-field">
                  <input-file-document :file="ci"  v-on:file="onCedulaChange"
              ...
              <li>
                <div class="col s6 file-field input-field">
                  <input-file-document :file="licencia" v-on:file="onLicenciaChange"
              ...
              <li>
                <p>
                  <label for="doc_verificados">
                    <input type="checkbox" v-model="form.gcdatos_verif" id="gcdatos_verif" class="filled-in" checked="checked" />
