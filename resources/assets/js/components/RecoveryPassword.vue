	...
	<section id="contacto" class="text-center g-color-gray-dark-v5">
		<div class="container g-max-width-770 g-back-gray g-mt-80">
			<div class="u-heading-v8-2 g-mb-80">
                ...
                <h3 class="h2 text-uppercase u-heading-v8__title g-font-size-18 gcfontlblue">Se enviará un codigo a su correo electrónico.</h3>
...
<script>
	export default {
		...
		methods: {
			_send(){
                axios.post(`password/recovery/send`, this.form)
                 .then(res => {
                 ...
                 .catch(err =>{
                    ...
                    console.log('no funciona by catch', err)
                 })
            },
		},
	}
